...
void display(void)
{
 ...
 glLoadName(TEXTID);
 glColor3f(0,0,0);
 DrawTextXY(-2.5,0.2,2.0,0.0015,"4SO20CS096");
 DrawTextXY(-2.5,0.5,2.0,0.0015,"NICOLE");
 DrawTextXY(2.5,2.2,-2.0,0.0025,"4SO20CS099");
 DrawTextXY(2.5,2.7,-2.0,0.0030,"NISHAYNE");
  glFlush();
  glutSwapBuffers();
...
int main(int argc, char **argv)
{
  ...
  glutCreateWindow("Robot Walking at Night in the City");
  myinit();
